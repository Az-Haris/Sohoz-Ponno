...
">
        ...
        >
          আমাদের ফেসবুক পেজে ইনবক্স করে অথবা দেওয়া ফোন নম্বরে যোগাযোগ করে অর্ডার করা যায়। আমরা হোম ডেলিভারি দিয়ে থাকি সারা বাংলাদেশে।
        </AccordionItem>
        <AccordionItem
          value="4"
          trigger="ডেলিভারি চার্জ ও সময়সীমা কেমন?"
        >
          ঢাকার ভিতরে সাধারণত ১ দিন, ঢাকার বাইরে ২-৩ কর্মদিবস লাগে। ডেলিভারি চার্জ অর্ডারের পরিমাণ ও লোকেশন অনুযায়ী নির্ধারিত হয়।
        </AccordionItem>
        <AccordionItem
          value="5"
